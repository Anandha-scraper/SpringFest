 ...
 * forcing a duplicate row. `draft` is saved with no fee/order at all — filling
 * in the form doesn't commit to paying — and turns into a normal `pending`
 * row the moment its owner submits it for real. Status only ever advances on
 * the server.
 */
